    ...
    internal static class Async
    {
        public static void HandlePublishConfirmsAsynchronously()
        {
            ...
            void CleanOutstandingConfirms(ulong sequenceNumber, bool multiple)
            {
                ...
                {
                    var confirmed =
                        outstandingConfirms.Where(k => 
                                                        k.Key <= sequenceNumber);
            ...
            channel.BasicNacks += (sender, ea) =>
            {
                ...
                Console.WriteLine(
                    $"Message with body {body} has been nack-ed. " +
                    $"Sequence number: {ea.DeliveryTag}, multiple: {ea.Multiple}");
                CleanOutstandingConfirms(ea.DeliveryTag, ea.Multiple);
            };
            ...
            for (var i = 0; i < PublisherConfirms.MessageCount; i++)
            {
                ...
                channel.BasicPublish("", queueName, 
                               null, Encoding.UTF8.GetBytes(body));
            }
            ...
            Console.WriteLine(
                ...
                $"and handled confirm asynchronously {timer.ElapsedMilliseconds:N0} ms");
        }
